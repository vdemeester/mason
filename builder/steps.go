...
type Step interface {
	...
	Execute(ctx context.Context, helper base.Helper, config *Config) (*Config, error)
}
...
func (s *NoopStep) Execute(ctx context.Context, helper base.Helper, config *Config) (*Config, error) {
	return config, nil
}
