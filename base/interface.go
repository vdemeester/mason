// Package base provides the base helper for building client-side builder.
...
type Helper interface {
	...
	ContainerCommit(ctx context.Context, name string, options types.ContainerCommitOptions) (string, error)
